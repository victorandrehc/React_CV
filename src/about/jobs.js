export const jobsList = [
    {
        ...
        duties: [ 
                "Development and implementation of the electronic, software and real-time control from the new SOAR telescope Adaptive optics module (SAMplus). I'm designing and coding a MIMO control system using C, C++, LabVIEW and Python."
            ],
        id: 1,
